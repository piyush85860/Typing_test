...
const Landing = () => {
  ...
  bg-clip-text text-transparent translate-y-[-10px]  translate-x-[10px]'>TYPHONIC</h1>
            ...
            <div className='absolute translate-y-50'><button onClick={()=>{navigate("/Section1")}} className='hover:bg-black text-2xl px-5 py-2 rounded-xl font-light text-white/80 bg-[#c87aff] font-[Inter]'>Test your Speed</button></div>
